...
public class UpdateChecker {
    ...
    public static void checkForUpdate(Context context, boolean force) {
        ...
        checkForUpdate(context, title, message, updateButton, cancelButton, force);
    }
    ...
    public static void checkForUpdate(Context context
            ...
            , String cancelButton
            , boolean force) {
        new UpdateCheckerProcess(context, title, message, updateButton, cancelButton, force).execute();
    }
...
//                return newVersion;
        ...
        protected void onPostExecute(String onlineVersion) {
            ...
            if (isNewUpdateOnStore) {
                openDialog(context, title, message, updateButton, cancelButton, force);
            }
